...
#from pylearn2.datasets.cifar10single import CIFAR10 
...
if __name__ == "__main__":
    ...
    cnn_layer_output = lasagne.layers.get_output(cnn, deterministic= True) 
    ...
    #cnn = lasagne.layers.MaxPool2DLayer(cnn, pool_size=(2, 2),pad=1)
    pad_layer_output = lasagne.layers.get_output(cnn, deterministic= True) 
    ...
    observe_fn1=theano.function([input],pad_layer_output)
    observe_fn2=theano.function([input],cnn_layer_output)
