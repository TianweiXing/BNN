...
def train(train_fn,val_fn,
	...
	print "the ", epoch, "-th epoch:"# swd~~~see epoch
        ...
        all_params = lasagne.layers.get_all_params(model)# all params stored 
        file_path='all_parameters_file.txt'
        np.savetxt(file_path,all_params,fmt='%s')
#        print("counts all parameters of all layers: "+ str(lasagne.layers.count_params(model)))
#        lasagne.layers.get_all_layers(model)# all layers used by model
