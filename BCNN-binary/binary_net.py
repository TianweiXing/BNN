...
def train(train_fn,val_fn,
    ...
    def val_epoch(X,y):
        ...
        for i in range(batches):
            if i%100==0:
                print i, "in", batches  #swd~~~monitor
	...
	print "the ", epoch+1, "-th epoch:"# swd~~~see epoch
	...
	# swd~~ save for validation curve
	train_loss_record.append(train_loss)
	np.savetxt("train_loss_record.csv", train_loss_record, delimiter=",")

	# swd~~ save for validation curve
	val_err_record.append(val_err)
	np.savetxt("val_err_record.csv", val_err_record, delimiter=",")
        val_loss_record.append(val_loss)
	np.savetxt("val_loss_record.csv", val_loss_record, delimiter=",")
        ...
        #==== JH: By the end of the training, we test the trained model with test set ====#
